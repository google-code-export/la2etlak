...
#>>>>>>> b3925240852892f2d8431399fc0f2d5bafeefb2d
  ...
  test "stories are sorted correctly" do
    ...
    story1.save
    story2 = Story.new
    story2.title = "Test Story2"
    story2.interest = int
    story2.deleted = false
    story2.hidden = true
    story2.rank = 124
    story2.save
    story3 = Story.new
    story3.title = "Test Story3"
    story3.interest = int
    story3.deleted = false
    story3.hidden = false
    story3.rank = 140
    story3.save
    story4 = Story.new
    story4.title = "Test Story4"
    story4.interest = int
    story4.deleted = false
    story4.hidden = false
    story4.rank = 130
    story4.save
